        ...
        children: [
          ...
          Positioned(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                (widget.game as Snake).togglePauseState();
                setState(
                      () {
                    isPaused = !isPaused;
                  },
                  ...
                  children: [
                    Padding(
                      ...
                      child: GestureDetector(
                        onTapDown: (details) {
                          (widget.game as Snake).player.moveLeft();
                        },
                        onTapUp: (details) {
                          // (widget.game as Snake).player.resetDirection();
                        },
                        child: Material(
                          color: Colors.transparent,
                          elevation: 3,
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTapDown: (details) {
                          (widget.game as Snake).player.moveRight();
                        },
                        onTapUp: (details) {
                          // (widget.game as Snake).player.resetDirection();
                        },
